    ...
    for ep in range(num_episodes):
        ...
        while complete == False:
            ...
            if complete:
                ...
                if (ep + 1) % 10000 == 0:
                    torch.save(pe.network.state_dict(), 'saved_policies_cartpole1/undiscounted/saved_network_'+ str(ep + 1) + '.pkl')
                '''
                if flag == 1:
...
if __name__ == '__main__':
    ...
    for run in range(numrun):
        ...
        fwrite = open('runs_data_cartpole1/undiscounted/'+str(run)+'.pkl','wb')
